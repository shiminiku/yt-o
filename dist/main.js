...
import { extractVideoId, getPlayerResponse, getSCVideoURL, getVideoURL, USER_AGENT } from "./index.js";
import got from "got";
function printUsage() {
    console.log();
    console.log("Usage");
...
if (download) {
    ...
    while (gotUntil < len) {
        ...
        console.log("...GOT", gotLen.toLocaleString(), "bytes", "in", (tend - tstart).toLocaleString(), "ms", `(${speed.toLocaleString()} bytes/s)`);
        f.write(res.rawBody);
